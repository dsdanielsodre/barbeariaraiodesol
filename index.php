...
<body>
  <!-- Navbar -->
  <!--<nav class="navbar navbar-expand-md navbar-dark ml-0 fixed-top bg-dark" style="">
    <div class="container">
      <div class="row">
        <div class="col-md-6 ml-1 w-100" style=""><img class="d-block rounded-right rounded-top rounded-bottom rounded-left img-fluid rounded-circle w-25" src="img/logo.png"></div>
      </div>
...
<footer>
       ...
       <div class="row" id="caixa">
          <div class="rodape col-sm-12 col-lg-6">
             ...
             <h5>
             Para saber mais sobre a Barbearia Raio de Sol, nossos produtos e serviços entre em contato conosco.
             <h5>
             </p>
             <br>
             <p>
             <h5>Fone: <p>
               (11) 9.1336-4608 (Claro)</h5></p>
             </p>
             <p>
             <h5>Email: </h5>
             <h5 style="font-size:19px;">contato@barbeariaraiodesol.com </h5>
          ...
          <div class="rodape col-sm-12 col-lg-5">
             ...
             <p>
             <h5> Na Barbearia Raio de Sol, nos dedicamos em fornecer a nossos clientes um serviço cordial.
                Nós valorizamos a satisfação de nossos clientes.
             </h5>
             </p>
             <p>
             <h5>Inaugurada em Dezembro/2021, a Barbearia Raio de Sol trás a inovação e o clássico unidos lado a lado.
             </h5>
             </p>
             <p>
